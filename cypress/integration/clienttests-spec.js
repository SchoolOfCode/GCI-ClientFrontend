...
// describe("decline eligibility criteria", () => {
//   before(() => {
//     cy.signIn();
//   });
...
//     cy.contains("Section 2").should("be.visible");
...
//     cy.contains("button", "Submit").click({ force: true });
//     cy.wait(1000);
//     cy.contains("please complete all required fields. These are marked with a red asterisk").should("be.visible");
//     cy.wait(1000);
//   });
...
describe("incorrectly filling stages on application, expecting end result to show alert to user", () => {
  ...
  it("incorrectly filling stage one application, expecting end result to show alert to user", () => {
    ...
    cy.wait(1000);
    //this currentyl does work fix it, doesnt see the alert so last step fails.
  });
});
